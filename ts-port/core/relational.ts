...
import {mix, HashDict} from "./utility.js";

// eslint-disable-next-line no-unused-vars
const Relational = (superclass: any) => class Relational extends mix(superclass).with(Basic) {
    ...
    */
    ...
    ValidRelationOperator: HashDict = new HashDict();

    is_Relational = true;

    // !!! constructor and methods not yet implemented
};
